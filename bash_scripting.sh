...
cond_test(){
    read -sp "Enter your name: " name1
    echo ""
    read -sp "Enter a second name: " name2
    echo ""
    if [[ "$name1" == "$name2" ]]; then
        echo "hello"
    else
...
check_sum(){
    ...
    read -sp "Enter the sum of the two numbers: " sum
    echo ""
    if (( number1 + number2 == sum )); then
        echo "correct"
    else
        echo "incorrect"
    fi
...
infinite_loop(){
    ...
    while :; do
        ...
        echo $num1
	echo $num2
	read -sp "Enter the sum of the two numbers: " sum1
        echo ""	
	if (( num1 + num2 == sum1 )); then
            echo "correct"
   	else 
            echo "incorrect"
        fi
